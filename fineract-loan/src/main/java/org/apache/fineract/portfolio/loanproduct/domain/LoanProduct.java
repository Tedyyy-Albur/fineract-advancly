...
public class LoanProduct extends AbstractPersistableCustom<Long> {
    ...
    public static LoanProduct assembleFromJson(final Fund fund, final String loanTransactionProcessingStrategy,
        ...
        final List<LoanSupportedInterestRefundTypes> supportedInterestRefundTypes = Collections.emptyList();
        final LoanChargeOffBehaviour chargeOffBehaviour = LoanChargeOffBehaviour.REGULAR;
        final boolean isInterestRecognitionOnDisbursementDate = false;
        final DaysInYearCustomStrategyType daysInYearCustomStrategy = DaysInYearCustomStrategyType.FULL_LEAP_YEAR;
        final boolean enableIncomeCapitalization = false;
        final LoanCapitalizedIncomeCalculationType capitalizedIncomeCalculationType = LoanCapitalizedIncomeCalculationType.FLAT;
        final LoanCapitalizedIncomeStrategy capitalizedIncomeStrategy = LoanCapitalizedIncomeStrategy.EQUAL_AMORTIZATION;
        final LoanCapitalizedIncomeType capitalizedIncomeType = LoanCapitalizedIncomeType.FEE;
        ...
        return new LoanProduct(fund, loanTransactionProcessingStrategy, loanProductPaymentAllocationRules, loanProductCreditAllocationRules,
                ...
                false,
                DaysInYearCustomStrategyType.FULL_LEAP_YEAR,
                false,
                LoanCapitalizedIncomeCalculationType.FLAT,
                LoanCapitalizedIncomeStrategy.EQUAL_AMORTIZATION,
                LoanCapitalizedIncomeType.FEE
        );
    ...
    public Map<String, Object> update(final JsonCommand command, final AprCalculator aprCalculator, FloatingRate floatingRate) {
        ...
        if (command.isChangeInIntegerParameterNamed(accountingTypeParamName, this.accountingRule.getValue())) {
        ...
        if (command.isChangeInIntegerParameterNamedWithNullCheck(
                ...
                this.loanProductRelatedDetail.getInstallmentAmountInMultiplesOf())) {
            ...
            this.loanProductRelatedDetail.setInstallmentAmountInMultiplesOf(newValue);
        }
